...
stack_fulldata <- read.csv(file.path("data", "stack_fulldata.csv"))
dice_fulldata <- read.csv(file.path("data", "dice_fulldata.csv"))
glass_fulldata <- read.csv(file.path("data", "glass_fulldata.csv"))
